...
<template>
  <div class="card">
    ...
    <p>
      ...
      <a href="https://github.com/primefaces/primeicons" class="font-medium text-primary hover:underline">PrimeIcons</a> library, the official icons
      suite from <a href="https://www.primetek.com.tr" class="font-medium text-primary hover:underline">PrimeTek</a>.
    </p>
...
&lt;i class="pi pi-times"&gt;&lt;/i&gt;</code></pre>
    ...
    <p>
      ...
      <a href="https://github.com/primefaces/primeicons/issues" class="font-medium text-primary hover:underline">request new icons</a> at the issue
      tracker.
    </p>
